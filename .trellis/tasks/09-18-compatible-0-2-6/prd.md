...
3. Preserve carpool accounting isolation, immutable term snapshots, admission/receipt/ledger transactions, 28-day four-cycle terms, existing legacy terms, boosts, reset timing, reconciliation and announcements.
