<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      >
        <img v-if="settingsLoaded" :src="siteLogo || '/water-train-logo.png'" :alt="siteName" class="h-full w-full object-contain" />
      </router-link>
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/carpool', label: t('nav.carpoolDetails'), icon: UsersIcon, hideInSimpleMode: true },
