...
var ProviderSet = wire.NewSet(
	...
	wire.Bind(new(service.CarpoolRepositoryAPI), new(*CarpoolRepository)),
	NewCarpoolResetRepository,
	wire.Bind(new(service.CarpoolResetRepositoryAPI), new(*CarpoolResetRepository)),
