...
$repoRoot = 'C:/WORK-SPACE/sub2api-compatible-0.2.6-20260918'
$backendRoot = Join-Path $repoRoot 'backend'
$sourceRoot = Join-Path $repoRoot 'validation/upgrade-026/repository-tests'
$privateRoot = 'C:/Users/Administrator/AppData/Local/Codex/PrivateTests/sub2api-upgrade-026-20260918/repository-tests'
...
$networkName = 'sub2api-upgrade026-test-net'
$postgresName = 'sub2api-upgrade026-integration-postgres'
$postgresAlias = 'carpool-integration-db'
$redisName = 'sub2api-upgrade026-integration-redis'
$redisAlias = 'carpool-integration-redis'
$runnerName = 'sub2api-upgrade026-integration-runner'
$volumeName = 'sub2api-upgrade026-integration-pgdata'
$databaseName = 'sub2api_upgrade026_integration_20260918'
$databaseUser = 'carpool_integration'
$taskLabel = '09-18-compatible-0-2-6'
...
try {
    ...
    $generatorTest = Invoke-Process -Executable $goBinary -WorkingDirectory $backendRoot -Arguments @(
        'test', '../validation/upgrade-026/repository-tests/prepare-overlay.go',
        '../validation/upgrade-026/repository-tests/prepare_overlay_test.go'
    )
    ...
    $generator = Invoke-Process -Executable $goBinary -WorkingDirectory $backendRoot -Arguments @(
        'run', '../validation/upgrade-026/repository-tests/prepare-overlay.go',
    ...
    } -Arguments @('test', '-c', '-tags=integration,timetzdata', "-overlay=$overlay", '-o', $testBinary, './internal/repository')
